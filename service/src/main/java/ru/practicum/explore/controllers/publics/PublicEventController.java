...
import ru.practicum.explore.services.publics.PublicEventService;
    ...
    public Collection<EventShortDto> getAllEvents(@RequestParam(required = false) String text,
        ...
        if (sort != null) {
            if (sort.equals("EVENT_DATE")) {
                ...
                throw new InvalidRequestException("Sort is wrong");
            }
        }

        return publicEventService.getAllEvents(new EventsParamsReader(text, categories, paid, rangeStart,
